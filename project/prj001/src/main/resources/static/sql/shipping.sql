...
ex)
INSERT INTO shipping VALUES(NULL, 'name', true, 'com_num', 'fax_num', 'add1', 'add2', 'city', 'country', 'postcode', 'email', now(), 'orgName', 'savedFileName', 'savedFilePathName', 'savedFileSize', 'folderName', 'ext');
